...
//    Route::get('/login', ['name' => 'auth.login.show', 'action' => function () {
//        return view('auth.login');
//    }]);
//    Route::post('/login', ['name' => 'auth.login.submit', 'action' => function (Request $request) {
//
//    }]);
//    Route::get('/logout', ['name' => 'auth.logout', 'action' => function () {
