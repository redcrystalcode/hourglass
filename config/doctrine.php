    ...
    */
    'managers' => [
        'default' => [
            ...
            'meta' => 'fluent',
            'mappings' => [
                Hourglass\Entities\Mappings\JobMapping::class,
                Hourglass\Entities\Mappings\UserMapping::class,
                Hourglass\Entities\Mappings\ReportMapping::class,
                Hourglass\Entities\Mappings\AccountMapping::class,
                Hourglass\Entities\Mappings\LocationMapping::class,
                Hourglass\Entities\Mappings\EmployeeMapping::class,
                Hourglass\Entities\Mappings\JobShiftMapping::class,
                Hourglass\Entities\Mappings\RoundingRuleMapping::class,
                Hourglass\Entities\Mappings\EmployeeGroupMapping::class,
                Hourglass\Entities\Mappings\TimesheetEntryMapping::class,
                Hourglass\Entities\Mappings\PausedTimesheetEntryMapping::class,
            ],
