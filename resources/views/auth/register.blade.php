            ...
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--4-offset-desktop mdl-cell--6-col-tablet mdl-cell--1-offset-tablet">
                    <div class="login-card card card--animate-in card--4dp">
                        <h2 class="card__title card__title--xl">Create an Account</h2>

                        <form method="POST" action="{{ url('/register') }}" class="login-form">
                            {!! csrf_field() !!}
                            <div class="mdl-textfield mdl-textfield--floating-label mdl-textfield--full-width mdl-js-textfield {{ $errors->has('account') ? 'mdl-textfield--invalid' : '' }}">
                                <input class="mdl-textfield__input" type="text" id="account" name="account"
                                       tabindex="1" autofocus value="{{ old('account') }}">
                                <label class="mdl-textfield__label" for="account">Company Name</label>
                                @if ($errors->has('account'))
                                    <div class="mdl-textfield__error">{{ $errors->first('account') }}</div>
                                @endif
                            </div>

                            <div class="mdl-textfield mdl-textfield--floating-label mdl-textfield--full-width mdl-js-textfield {{ $errors->has('name') ? 'mdl-textfield--invalid' : '' }}">
                                <input class="mdl-textfield__input" type="text" id="name" name="name"
                                       tabindex="1" autofocus value="{{ old('name') }}">
                                <label class="mdl-textfield__label" for="name">First and Last Name</label>
                                @if ($errors->has('name'))
                                    <div class="mdl-textfield__error">{{ $errors->first('name') }}</div>
                                @endif
                            </div>
                            ...
                            <div class="mdl-textfield mdl-textfield--floating-label mdl-textfield--full-width mdl-js-textfield {{ $errors->has('email') ? 'mdl-textfield--invalid' : '' }}">
                                <input class="mdl-textfield__input" type="email" id="email" name="email"
                                       tabindex="1" autofocus value="{{ old('email') }}">
                                <label class="mdl-textfield__label" for="email">Email</label>
                                @if ($errors->has('email'))
                                    <div class="mdl-textfield__error">{{ $errors->first('email') }}</div>
                                @endif
                            </div>
                            ...
                            <div class="mdl-textfield mdl-textfield--floating-label mdl-textfield--full-width mdl-js-textfield {{ $errors->has('password') ? 'mdl-textfield--invalid' : '' }}">
                                ...
                                @if ($errors->has('password_confirmation'))
                                    <div class="mdl-textfield__error">{{ $errors->first('password_confirmation') }}</div>
                                @endif
                            </div>

                            <div class="mdl-selectfield mdl-js-selectfield mdl-selectfield--floating-label">
                                <select id="timezone" class="mdl-selectfield__select" name="timezone">
                                ...
                                <label class="mdl-selectfield__label" for="gender">Timezone</label>
                            </div>

                            <div class="mdl-textfield__hint">
                                Already have an account? <a href="/login" tabindex="-1">Click here to log in.</a>
                            </div>

                            <div class="text-right">
                                <input tabindex="3" type="submit" value="Register"
