...
import template from 'templates/employees/groups/manage.tpl';

const ManageGroupView = ItemView.extend({
    template,
    actionSheetOptions() {
    ...
    initialize(options) {
        this.model = options.model || new AgencyModel();
    },
    onShow() {
...
mixin(ManageGroupView, AddsModelLoadingStateToActionSheet);
